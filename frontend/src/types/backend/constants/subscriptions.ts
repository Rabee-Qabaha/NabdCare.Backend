...
export class Subscriptions {
  static readonly descriptions: { [key: string]: string; } = {"Subscriptions.View":"View subscriptions belonging to own clinic or others (if SuperAdmin)","Subscriptions.ViewActive":"View only the active subscription for a clinic","Subscriptions.ViewAll":"View all subscriptions across all clinics (SuperAdmin only)","Subscriptions.Create":"Create new subscriptions (SuperAdmin only)","Subscriptions.Edit":"Edit existing subscriptions","Subscriptions.Cancel":"Cancel a subscription","Subscriptions.HardDelete":"Permanently delete a subscription (SuperAdmin only)","Subscriptions.ChangeStatus":"Change subscription status (SuperAdmin only)","Subscriptions.Renew":"Renew a subscription for a clinic (SuperAdmin only)","Subscriptions.ToggleAutoRenew":"Enable or disable auto-renew for a subscription","Subscriptions.PurchaseAddons":"Purchase additional users or branches for the subscription"};
  ...
  static readonly cancel: string = "Subscriptions.Cancel";
  ...
  static readonly purchaseAddons: string = "Subscriptions.PurchaseAddons";
}
