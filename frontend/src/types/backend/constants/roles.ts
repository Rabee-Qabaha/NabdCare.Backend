...
export class Roles {
  static readonly descriptions: { [key: string]: string } = {
    'Roles.ViewAll': 'View all roles (system + clinic + templates)',
    'Roles.ViewSystem': 'View system roles (SuperAdmin only)',
    'Roles.ViewTemplates': 'View template roles for cloning',
    'Roles.ViewClinic': 'View roles of a specific clinic',
    'Roles.View': 'View a specific role by ID',
    'Roles.Create': 'Create new roles (clinic-level)',
    'Roles.Clone': 'Clone template roles to clinic',
    'Roles.Edit': 'Edit existing roles',
    'Roles.Delete': 'Delete clinic roles (cannot delete system roles)',
  };
