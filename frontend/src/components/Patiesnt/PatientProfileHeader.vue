<template>
  <div class="card shadow-2 border-round overflow-hidden p-0">
    ...
    <!-- Profile Info -->
    <div
      class="relative flex flex-col md:flex-row items-start md:items-center px-4 md:px-6 py-6 md:py-10 md:pl-40"
    >
      <!-- Avatar -->
      <div
        class="absolute md:absolute -top-16 left-4 md:left-6 border-3 border-white border-round overflow-hidden shadow-2"
      ...
      <div class="mt-20 md:mt-0 md:ml-8 flex-1 w-full">
        ...
        <div
          class="flex flex-col sm:flex-row sm:flex-wrap gap-2 text-500 text-sm mt-2"
        >
