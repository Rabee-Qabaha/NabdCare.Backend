<template>
    <div class="card mb-0">
        <div class="flex justify-between mb-4">
            <div>
                <span class="block text-muted-color font-medium mb-4">{{ header }}</span>
            ...
            <!-- Icon container -->
            <div :class="['flex items-center justify-center rounded-border', colorClasses.bg]" style="width: 2.5rem; height: 2.5rem">
...
<script setup lang="ts">
    ...
    const colorMap = {
        ...
        orange: { bg: 'bg-orange-100 dark:bg-orange-400/10', text: 'text-orange-500' },
        cyan: { bg: 'bg-cyan-100 dark:bg-cyan-400/10', text: 'text-cyan-500' },
        purple: { bg: 'bg-purple-100 dark:bg-purple-400/10', text: 'text-purple-500' }
    };
