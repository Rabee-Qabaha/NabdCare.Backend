...
import type { SubscriptionStatus, SubscriptionType } from '@/types/backend/index';
...
export function useClinicSubscriptions(clinicId: string, params?: Record<string, any>) {
  return useQueryWithToasts({
...
export function useUpdateSubscription() {
  return useMutationWithInvalidate({
    ...
    invalidateKeys: [(variables) => subscriptionsKeys.byId(variables.id), subscriptionsKeys.all],
