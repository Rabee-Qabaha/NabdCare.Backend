...
public class PaymentProfile : Profile
{
    public PaymentProfile()
    {
        ...
        CreateMap<CreatePaymentRequestDto, Payment>()
            ...
            .ForMember(dest => dest.BaseExchangeRate, opt => opt.Ignore()) // Calculated in service
            .ForMember(dest => dest.FinalExchangeRate, opt => opt.Ignore()) // Calculated in service
            .ForMember(dest => dest.AmountInFunctionalCurrency, opt => opt.Ignore()); // Calculated in service
