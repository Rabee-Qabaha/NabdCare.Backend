        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FormSchema = table.Column<string>(type: "jsonb", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClinicalTemplates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClinicalTemplates_Clinics_ClinicId",
                        column: x => x.ClinicId,
                        principalTable: "Clinics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicalAlertNote = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ClinicId = table.Column<Guid>(type: "uuid", nullable: false),
                    PlanId = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false, defaultValue: "STD_M"),
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    PurchasedBranches = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    IncludedBranchesSnapshot = table.Column<int>(type: "integer", nullable: false, defaultValue: 1),
                    BonusBranches = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    PurchasedUsers = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    IncludedUsersSnapshot = table.Column<int>(type: "integer", nullable: false, defaultValue: 1),
                    BonusUsers = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CancellationReason = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    ClinicalEncounterId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PractitionerSchedules_Clinics_ClinicId",
                        column: x => x.ClinicId,
                        principalTable: "Clinics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PractitionerSchedules_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VitalsSnapshot = table.Column<string>(type: "jsonb", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ClinicalEncounters_Clinics_ClinicId",
                        column: x => x.ClinicId,
                        principalTable: "Clinics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClinicalEncounters_Users_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClinicalEncounterId = table.Column<Guid>(type: "uuid", nullable: true),
                    BilledToName = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    BilledToAddress = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    BilledToTaxNumber = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    PdfUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    HostedPaymentUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    IssueDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    DueDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    PaidDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    PaymentAttemptCount = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Invoice_Polymorphic", "(\"SubscriptionId\" IS NOT NULL AND \"PatientId\" IS NULL) OR (\"PatientId\" IS NOT NULL AND \"SubscriptionId\" IS NULL)");
                    table.ForeignKey(
                        name: "FK_Invoices_ClinicalEncounters_ClinicalEncounterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClinicalEncounters_ClinicId",
                table: "ClinicalEncounters",
                column: "ClinicId");

            migrationBuilder.CreateIndex(
                name: "IX_ClinicalEncounters_Date",
                table: "ClinicalEncounters",
                column: "Date");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClinicalTemplates_ClinicId",
                table: "ClinicalTemplates",
                column: "ClinicId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_ClinicalEncounterId",
                table: "Invoices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PractitionerSchedules_ClinicId",
                table: "PractitionerSchedules",
                column: "ClinicId");

            migrationBuilder.CreateIndex(
                name: "IX_PractitionerSchedules_UserId",
                table: "PractitionerSchedules",
                column: "UserId");
