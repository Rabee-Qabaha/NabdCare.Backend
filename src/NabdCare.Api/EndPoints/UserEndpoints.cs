...
public static class UserEndpoints
{
    public static void MapUserEndpoints(this WebApplication app)
    {
        ...
        // Update user info
        group.MapPut("/{id:guid}", async (Guid id, UpdateUserRequestDto dto, IUserService userService) =>
        {
        ...
        // Update user role
        group.MapPut("/{id:guid}/role", async (Guid id, UpdateUserRoleDto dto, IUserService userService) =>
        {
        ...
        group.MapPost("/{id:guid}/change-password", async (Guid id, ChangePasswordRequestDto dto, IUserService userService) =>
        {
        ...
        group.MapPost("/{id:guid}/reset-password", async (Guid id, ResetPasswordRequestDto dto, IUserService userService) =>
        {
        ...
        group.MapPost("/{id:guid}/admin-reset-password", async (Guid id, ResetPasswordRequestDto dto, IUserService userService) =>
        {
